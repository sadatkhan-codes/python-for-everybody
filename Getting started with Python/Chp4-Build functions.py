...
# hours up to 40 and time-and-a-half for the hourly rate for all hours worked 
# above 40 hours. Put the logic to do the computation of pay in a function called 
...
# convert the string to a number. Do not worry about error checking the user input 
# unless you want to - you can assume the user types numbers properly. Do not name 
